import type { Property } from "obsidian-clipper/src/types/types";
import { escapeDoubleQuotes } from "obsidian-clipper/src/utils/string-utils";
...
export async function generateFrontmatter(
	...
	for (const property of properties) {
		...
		const propertyType =
			property.type || propertyTypes?.get(property.name) || "text";
