import type { Property, Template } from "obsidian-clipper/src/types/types";
import { renderTemplate as clipperRenderTemplate } from "obsidian-clipper/src/utils/renderer";
